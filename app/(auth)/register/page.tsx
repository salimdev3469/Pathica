    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                ...
                setStatusMessage({ type: 'success', text: 'Account created. Preparing your dashboard...' });
                ...
                <div className="w-full max-w-md space-y-8">
                    <Card className="shadow-none border-0 sm:shadow-lg sm:border sm:border-t-4 sm:border-t-slate-900 bg-transparent sm:bg-white rounded-xl">
                        <CardHeader className="space-y-1 pb-4">
                            <CardTitle className="text-3xl font-medium tracking-tight text-center text-slate-900">Create an account</CardTitle>
                        ...
                        <CardContent className="grid gap-4">
                            ...
                            {statusMessage && (
                                <div
                                    className={`rounded-md border px-3 py-2 text-sm ${statusMessage.type === 'error'
