...
export default async function CoverLettersDashboardPage() {
  ...
  return (
    <DashboardShell active="coverLetters" userEmail={user.email} userName={user.user_metadata?.full_name} locale={locale} wallet={wallet} billingSchemaMissing={billingSchemaMissing}>
