      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            size="sm"
            variant="outline"
            className="h-8 rounded-lg border-[#EAE2DA] bg-white px-3 text-xs font-semibold text-[#6B7280] shadow-sm transition hover:bg-slate-50 hover:text-[#171717]"
          >
            <Share2 className="mr-1.5 h-3.5 w-3.5" /> Share
          </Button>
        </PopoverTrigger>

        <PopoverContent align="end" className="w-56 p-2 rounded-xl border-[#EAE2DA] bg-white shadow-lg">
          <div className="flex flex-col gap-1">
            <a
              href={sharePayload.linkedinUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex h-9 items-center gap-2 rounded-md px-2 text-sm font-medium text-[#171717] transition hover:bg-slate-50"
            >
            ...
            <button
              ...
              className="inline-flex h-9 items-center gap-2 rounded-md px-2 text-left text-sm font-medium text-[#171717] transition hover:bg-slate-50"
            >
              <Link2 className="h-4 w-4 text-[#6B7280]" /> Copy Share Link
            </button>
            ...
            <button
              ...
              className="inline-flex h-9 items-center gap-2 rounded-md px-2 text-left text-sm font-medium text-[#171717] transition hover:bg-slate-50"
            >
              {isCopied ? <Check className="h-4 w-4 text-[#22C55E]" /> : <Copy className="h-4 w-4 text-[#6B7280]" />} Copy Share Text
            </button>
          </div>
        </PopoverContent>
      </Popover>
