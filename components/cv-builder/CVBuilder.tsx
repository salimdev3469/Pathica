...
import { Plus, Briefcase, GraduationCap, Code, FolderGit2, Save, Loader2, FileText } from 'lucide-react';
...
const PREBUILT_SECTIONS = [
    ...
    },
    {
        ...
        items: [
            { title: 'University Name', subtitle: 'Degree Name', date: 'Aug 2016 - May 2020', location: 'City, Country', bullets: '• CGPA: 3.8/4.0' }
        ]
    },
    {
        title: 'Projects',
